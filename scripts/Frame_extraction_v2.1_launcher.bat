...
set CONDAPATH=C:\Users\Administrator\anaconda3
rem Define here the name of the environment
set ENVNAME=opencv

rem The following command activates the base environment.
rem call C:\Users\Pegoraro\Anaconda3\Scripts\activate.bat C:\Users\Pegoraro\Anaconda3
...
python Frame_extraction_v2.1.py
